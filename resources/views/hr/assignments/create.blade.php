  ...
  <div class="col-span-12">
    <div class="rounded-sm border border-stroke bg-white px-5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
      <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-black dark:text-white">Tambah Penempatan Baru</h2>
      ...
      <form action="{{ route('hr.assignments.store') }}" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            >
              ...
              <option value="transferred" {{ old('status') == 'transferred' ? 'selected' : '' }}>Dipindahkan</option>
            </select>
          </div>
