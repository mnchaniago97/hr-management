  ...
  <div class="col-span-12">
    <div class="rounded-sm border border-stroke bg-white px-5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
      <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
        <div>
          <h2 class="text-xl font-semibold text-black dark:text-white">Pengembalian Cepat</h2>
          <p class="text-sm text-gray-500 mt-1">Form singkat untuk mencatat pengembalian.</p>
        </div>
      ...
      <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="p-4 sm:p-6 space-y-4">
          <p class="text-sm text-gray-500 dark:text-gray-400">
            Untuk pengembalian, buka detail peminjaman lalu klik tombol “Tandai Kembali”.
          </p>
          <a href="{{ route('asset.loans.index') }}" class="inline-flex items-center rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600">
