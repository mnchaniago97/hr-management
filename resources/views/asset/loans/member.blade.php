...
@section('title', 'Peminjaman Anggota')
  ...
  <div class="col-span-12">
    <div class="rounded-sm border border-stroke bg-white px-5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
      <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
        <div>
          <h2 class="text-xl font-semibold text-black dark:text-white">Peminjaman Anggota</h2>
          <p class="text-sm text-gray-500 mt-1">Riwayat peminjaman per anggota.</p>
        </div>
      ...
      <div class="mb-4 text-sm text-gray-500 dark:text-gray-400">
        Anggota: <span class="font-medium text-gray-800 dark:text-white/90">{{ $member->name }}</span>
      </div>
