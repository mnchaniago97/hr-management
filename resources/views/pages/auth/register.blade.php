...
@section('content')
    <div class="relative z-1 min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 p-4 sm:p-6 dark:from-gray-950 dark:via-gray-900 dark:to-slate-950">
        <div class="flex min-h-screen w-full flex-col justify-center py-8 sm:p-0 lg:flex-row lg:items-stretch lg:py-0 dark:bg-gray-900">
            <!-- Form -->
                    ...
                    <div class="mb-6 mt-6 flex flex-col items-center gap-3 text-center sm:mt-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Buat akun untuk mengakses dashboard KSR PMI UNP.
                            </p>
                        </div>
                    </div>
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <img src="/images/logo/logoksr.png" alt="Logo" class="h-20 w-auto" />
                        </a>
                        <p class="text-center text-white/90">
                            Loyalitas untuk kemanusiaan
                        </p>
                    </div>
                </div>
            </div>
