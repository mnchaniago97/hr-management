  ...
  <div class="col-span-12">
    <div class="rounded-sm border border-stroke bg-white px-5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
      <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
        <div>
          <h2 class="text-xl font-semibold text-black dark:text-white">Tambah Periode Program</h2>
          <p class="text-sm text-gray-500 mt-1">Isi detail periode baru lalu simpan.</p>
        </div>
      ...
      <form action="{{ route('program.periods.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div>
            ...
            <input type="number" id="year_start" name="year_start" value="{{ old('year_start') }}" required>
          </div>
          ...
          <div>
            ...
            <input type="number" id="year_end" name="year_end" value="{{ old('year_end') }}" required>
          </div>
